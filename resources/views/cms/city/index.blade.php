          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                {{-- <h3 class="card-title"> Index Data of City</h3> --}}
                <a href="{{ route('cities.create') }}" type="button" class="btn btn-info">Add New City</a>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $city->name }}</td>
                        <td>{{$city->street}}</td>
                        <td>  <span class="badge bg-info">{{$city->country->name}}</td>
